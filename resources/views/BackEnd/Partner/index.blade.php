    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="card-title d-flex justify-content-end mb-5">
                <a href="{{ route('admin.partner_create') }}" class="btn btn-primary btn-icon-text">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset('storage/image/'.$item->gambar_partner)}}" alt="" width="75"></td>
                            ...
                            <td class="d-flex gap-3 justify-content-center align-items-center">
                                ...
                                <a href="{{ route('admin.partner_edit', $item->id )}}"
                                    class="btn btn-outline-success btn-icon-text">
                                    Edit
                                </a>
                                <form action="{{ route('admin.partner_delete', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
